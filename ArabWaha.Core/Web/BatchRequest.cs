...
namespace ArabWaha
{
	public static class BatchRequest
	{
		...
		public static string ForProfile()
		{
			...
			sbRequest.AppendLine("GET GetIndividualProfileDetailsSet?$filter=nesIndividualId%20eq%20" + DebugDataSingleton.Instance.NesIndividualID + "&$format=json HTTP/1.1");
			sbRequest.AppendLine("\r");
			sbRequest.AppendLine("\r");
			sbRequest.AppendLine("--batch");
			sbRequest.AppendLine("Content-Type:application/http");
			...
			sbRequest.AppendLine("Content-Transfer-Encoding: binary");
			sbRequest.AppendLine("\r");
			sbRequest.AppendLine("GET EmploymentPreferencesSet?$filter=nesIndividualId%20eq%20" + DebugDataSingleton.Instance.NesIndividualID + "&$format=json HTTP/1.1");
			sbRequest.AppendLine("\r");
			sbRequest.AppendLine("\r");
			sbRequest.AppendLine("--batch");
