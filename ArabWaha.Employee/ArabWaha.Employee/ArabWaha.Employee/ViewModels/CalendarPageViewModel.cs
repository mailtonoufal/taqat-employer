...
{
    public class CalendarPageViewModel : AWMVVMBase, INavigatedAware
    {
        ...
        {
            // contruct from event
            EventsCollection.Add(new ScheduleAppointment { Subject=newEvent.TitleInfo, Location=newEvent.EventLocation,
